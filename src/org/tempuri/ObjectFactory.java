...
public class ObjectFactory {
    ...
    private final static QName _GetBalanceUsername_QNAME = new QName("http://tempuri.org/", "username");
    ...
    public JAXBElement<String> createGetBalanceUsername(String value) {
        return new JAXBElement<String>(_GetBalanceUsername_QNAME, String.class, GetBalance.class, value);
    }
    ...
    public JAXBElement<String> createRegisterCustomerUsername(String value) {
        return new JAXBElement<String>(_GetBalanceUsername_QNAME, String.class, RegisterCustomer.class, value);
    }
    ...
    public JAXBElement<String> createGeneratePasswordUsername(String value) {
        return new JAXBElement<String>(_GetBalanceUsername_QNAME, String.class, GeneratePassword.class, value);
    }
    ...
    public JAXBElement<String> createGetAllBoughtProductsUsername(String value) {
        return new JAXBElement<String>(_GetBalanceUsername_QNAME, String.class, GetAllBoughtProducts.class, value);
    }
    ...
    public JAXBElement<String> createLoginUsername(String value) {
        return new JAXBElement<String>(_GetBalanceUsername_QNAME, String.class, Login.class, value);
    }
    ...
    public JAXBElement<String> createCheckCredentialsPassword(String value) {
        return new JAXBElement<String>(_LoginPassword_QNAME, String.class, CheckCredentials.class, value);
    }
    ...
    public JAXBElement<String> createCheckCredentialsUsername(String value) {
        return new JAXBElement<String>(_GetBalanceUsername_QNAME, String.class, CheckCredentials.class, value);
    }
    ...
    public JAXBElement<String> createIsUsernameAvailableUsername(String value) {
        return new JAXBElement<String>(_GetBalanceUsername_QNAME, String.class, IsUsernameAvailable.class, value);
    }
